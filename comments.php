...
<?php if ( have_comments() ) : ?>
	<h3 class="h2 comments"><?php comments_number(__('<span>No</span> Responses', 'bonestheme'), __('<span>One</span> Response', 'bonestheme'), _n('<span>%</span> Response', '<span>%</span> Responses', get_comments_number(),'bonestheme') );?> to &#8220;<?php the_title(); ?>&#8221;</h3>
...
<section class="respond-form respond">
	...
	<h3 class="comment-form-title h2"><?php comment_form_title( __('Leave a Reply', 'bonestheme'), __('Leave a Reply to %s', 'bonestheme' )); ?></h3>
	...
	<ul class="comment-form-elements clearfix">
		...
		<li>
			...
			<input type="text" name="author" class="author" value="<?php echo esc_attr($comment_author); ?>" placeholder="<?php _e('Your Name*', 'bonestheme'); ?>" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> />
		</li>

		<li>
			<label for="email"><?php _e("Mail", "bonestheme"); ?> <?php if ($req) _e("(required)"); ?></label>
			<input type="email" name="email" class="email" value="<?php echo esc_attr($comment_author_email); ?>" placeholder="<?php _e('Your E-Mail*', 'bonestheme'); ?>" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> />
			<small><?php _e("(will not be published)", "bonestheme"); ?></small>
		</li>

		<li>
			<label for="url"><?php _e("Website", "bonestheme"); ?></label>
			<input type="url" name="url" class="url" value="<?php echo esc_attr($comment_author_url); ?>" placeholder="<?php _e('Got a website?', 'bonestheme'); ?>" tabindex="3" />
		</li>
	...
	<p><textarea name="comment" class="comment" placeholder="<?php _e('Your Comment here...', 'bonestheme'); ?>" tabindex="4"></textarea></p>

	<p>
		<input name="submit" type="submit" class="button submit" tabindex="5" value="<?php _e('Submit', 'bonestheme'); ?>" />
